package net.kathir.myapplication.ui.fragments;
...
import net.kathir.myapplication.adapter.PokemonAdapter;
import net.kathir.myapplication.databinding.FavoritesBinding;
import net.kathir.myapplication.model.Pokemon;
import net.kathir.myapplication.viewmodel.PokemonViewModel;
